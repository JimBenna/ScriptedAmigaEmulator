...
//const URL_DATABASE =URL.protocol+"//"+window.location.hostname+":"+location.port;
const URL_DATABASE = "http://"+window.location.hostname+":"+location.port;
...
const KST_1 = 1; 	/* Kickstart v1.2 r33.180 (1986)(Commodore)(A500-A1000-A2000).rom */
const KST_2 = 2; 	/* Kickstart v1.3 r34.5 (1987)(Commodore)(A500-A1000-A2000-CDTV).rom */
const KST_3 = 3; 	/* Kickstart v2.04 r37.175 (1991)(Commodore)(A500+).rom */
const KST_4 = 4; 	/* Kickstart v2.05 r37.350 (1992)(Commodore)(A600HD).rom */
const KST_5 = 5; 	/* kickstart v3.1 r40.63 A500 A600 A2000.rom */
const KST_6 = 6; 	/* Kickstart v3.1 r40.68 (1993)(Commodore)(A1200).rom */
const KST_7 = 7; 	/* Kickstart v3.1 r40.68 (1993)(Commodore)(A3000).rom */
const KST_8 = 8; 	/* Kickstart v3.1 r40.68 (1993)(Commodore)(A4000).rom */
const KST_9 = 9; 	/* Kickstart v1.3 r34.5 (1987)(Commodore)(A500-A1000-A2000-CDTV).rom AND CDTV Extended-ROM v1.0 (1991)(Commodore)(CDTV).rom */
const KST_10 = 10; 	/* Kickstart v3.1 r40.60 (1993)(Commodore)(CD32).rom AND CD32 Extended-ROM r40.60 (1993)(Commodore)(CD32).rom */

/*---------------------------------*/
/*    Kickstart files.             */

const AROS_ROM_FILE = "kick/aros-rom.bin";
const AROS_ROM_CRC = 0x32CFBE60;
const AROS_EXT_FILE = "kick/aros-ext.bin";
const AROS_EXT_CRC = 0xFD62316F;
const KICK12 = "kick/Kickstart 1.2 (33.180) A500_A1000_A2000.rom"
const KICK12_CRC = 0xA6CE1636;
const KICK13 = "kick/kickstart 1.3 (v34.5) A500_A1000_A2000.rom";
const KICK13_CRC = 0xC4F0F55F;
const KICK204 = "kick/kickstart 2.04 (v37.175) A500+.rom";
const KICK204_CRC = 0xC3BDB240; 
const KICK205 = "kick/Kickstart 2.05 (37.350) A600HD.rom"
const KICK205_CRC = 0x43B0DF7B;
const KICK31 = "kick/kickstart 3.1 (40.63) A500_A600_A2000.rom";
const KICK31_CRC = 0xFC24AE0D;
const KICK31A1200 = "kick/kickstart 3.1 (40.68) A1200.rom";
const KICK31A1200_CRC = 0x1483A091;
const KICK31A3000 = "kick/Kickstart 3.1 (40.68) A3000.rom";
const KICK31A3000_CRC = 0xEFB239CC;
const KICK31A4000 = "kick/Kickstart 3.1 (40.68) A4000.rom";
const KICK31A4000_CRC = 0xD6BAE334;
const CDTV_EXT_ROM = "kick/CDTV Extended-ROM (1.0) CDTV.rom";
const CDTV_EXT_ROM_CRC = 0x42BAA124;
const CD32_ROM = "kick/Kickstart 3.1 (40.60)  CD32.rom";
const CD32_ROM_CRC = 0x1E62D4A5;
const CD32_EXT_ROM = "kick/CD32 Extended-ROM (40.60) CD32.rom";
const CD32_EXT_ROM_CRC = 0x87746BE2;
/*---------------------------------*/


function dbEntry(t,nd, n,d,p,l,y, f,ks,no) {
...
const db = [
    new dbEntry(DBT_GAME,1, "Arkanoid",     					"Imagine",				"publisher",					"licence",		"1989",      	0,					KST_2, 			"https://www.lemonamiga.com/game/arkanoid-revenge-of-doh"),
	new dbEntry(DBT_GAME,1, "IK+",      						"System 3",				"publisher",					"licence",		"1988", 		0,					KST_2, 			""),
	new dbEntry(DBT_GAME,1, "Kick Off",          				"Dino Dini",			"Anco",							"licence", 		"1989", 		0,					KST_2, 			"https://www.lemonamiga.com/game/kick-off"),
	new dbEntry(DBT_GAME,1, "Kick Off 2",          				"Dino Dini",			"Anco",							"licence", 		"1990", 		0,					KST_2, 			"https://www.lemonamiga.com/game/kick-off-2"),
	new dbEntry(DBT_GAME,1, "Kick Off 2 Final Whistle", 		"Dino Dini",			"Anco",							"Licence", 		"1991", 		0,					KST_2, 			""),
	new dbEntry(DBT_GAME,1, "Kick Off 2 - Return to Europe", 	"Dino Dini",			"Anco",							"Licence", 		"1991", 		0,					KST_2, 			""),	
	new dbEntry(DBT_GAME,3, "Kick Off 3 - European Challenge",  "Dino Dini",			"Anco",							"Licence", 		"1994",			0,					KST_2, 			""),			
	new dbEntry(DBT_GAME,2, "Xenon 2",        					"Bitmaps Brothers",		"",								"FreeWare",    	"1989", 		DBF_MDC,			KST_2, 			""),
	new dbEntry(DBT_GAME,1, "Pacmania",    						"",						"",								"", 			"1994",			0,					KST_2, 			""),				
	new dbEntry(DBT_GAME,1, "Rick Dangerous 2",    				"Core",					"Microstyle",					"", 			"1990", 		0,					KST_2, 			"https://www.lemonamiga.com/game/rick-dangerous-2"),
	new dbEntry(DBT_GAME,1, "Speedball 2",    					"Bitmaps Brothers",		"",								"", 			"1994", 		0,					KST_2, 			""),			
	new dbEntry(DBT_GAME,2, "Goal",    							"",						"",								"", 			"1994", 		0,					KST_2, 			""),			
	new dbEntry(DBT_GAME,1, "Battle Chess",          			"Interplay Productions","Electronic Arts",				"Licence",   	"1988", 		0, 					KST_2,			"https://www.lemonamiga.com/game/battle-chess"),
	new dbEntry(DBT_GAME,1, "Bubble Bobble",  					"Software Creations",	"Taito",						"Licence",      "1988", 		0, 					KST_2,			"https://www.lemonamiga.com/game/bubble-bobble"),
	new dbEntry(DBT_GAME,2, "Mega lo Mania",  					"Sensible Software",	"Image Works",					"Licence",      "1991", 		0, 					KST_2,			"https://www.lemonamiga.com/game/mega-lo-mania"),
	new dbEntry(DBT_GAME,1, "PowerMonger",  					"Bullfrog Productions",	"Electronic Arts",				"Licence",      "1990", 		0, 					KST_2,			"https://www.lemonamiga.com/game/powermonger"),
	new dbEntry(DBT_GAME,5, "Slam Tilt - The Pinball Game",  	"Liquid Dezign",		"21st Century Entertainment",	"Licence",      "1996", 		DBF_MDC|DBF_AGA,	KICK31A1200,	"https://www.lemonamiga.com/game/slamtilt"),
	new dbEntry(DBT_GAME,3, "The Settlers",          			"Volker Wertich",		"Blue Byte",					"Licence",      "1993", 		0, 					KST_2,			"https://www.lemonamiga.com/game/settlers"),
	new dbEntry(DBT_GAME,4, "Flashback",          				"Delphine Software",	"US Gold",						"Licence",      "1992", 		DBF_MDC,			KST_2,			"https://www.lemonamiga.com/game/flashback"),
	new dbEntry(DBT_GAME,2, "Sensible World of Soccer",         "Sensible Software",	"Renegade",						"Licence",      "1996", 		DBF_ECS,			KST_3,			"https://www.lemonamiga.com/game/sensible-world-of-soccer-96-97"),			
...
//	new dbEntry(DBT_TOOL,1, "AIBB 6.5",           "Peter LaMonte Koop","","FW",    "1993", 0,, "Type 'aibb' at the console. Be very patient at the 'Evaluating System...' screen."),
	new dbEntry(DBT_TOOL,1, "SysInfo",        URL_SYSINFO,"","FW",             "2012",0 ,KST_2, "Type 'sysinfo' (y=z) at the console."),
	new dbEntry(DBT_TOOL,1, "X-Copy Pro",         "Cachet","","FW",                "1989",0 ,KST_2, ""),
	new dbEntry(DBT_TOOL,1, "XSysInfo",         "Cachet","","FW",                "1989",0 ,0, "")
];
...
function getDatabaseConfig() {
	...
	switch (dbe.kickstart) {
    case KST_1:
        cache.req(URL_DATABASE, KICK12, 0x40000, KICK12_CRC, cfg.memory.rom);
        break;
    case KST_2:
        cache.req(URL_DATABASE, KICK13, 0x40000, KICK13_CRC, cfg.memory.rom);
        break;
    case KST_3:
        cache.req(URL_DATABASE, KICK204, 0x80000, KICK204_CRC, cfg.memory.rom);
        break;
    case KST_4:
        cache.req(URL_DATABASE, KICK205, 0x80000, KICK205_CRC, cfg.memory.rom);
        break;
    case KST_5:
        cache.req(URL_DATABASE, KICK31, 0x80000, KICK31_CRC, cfg.memory.rom);
        break;
    case KST_6:
        cache.req(URL_DATABASE, KICK31A1200, 0x80000, KICK31A1200_CRC, cfg.memory.rom);
        break;
    case KST_7:
        cache.req(URL_DATABASE, KICK31A3000, 0x80000, KICK31A3000_CRC, cfg.memory.rom);
        break;
    case KST_8:
        cache.req(URL_DATABASE, KICK31A4000, 0x80000, KICK31A4000_CRC, cfg.memory.rom);
        break;
    case KST_9:
        cache.req(URL_DATABASE, KICK13, 0x40000, KICK13_CRC, cfg.memory.rom);
        cache.req(URL_DATABASE, CDTV_EXT_ROM, 0x40000, CDTV_EXT_ROM_CRC, cfg.memory.extRom);		
        break;
    case KST_10:
        cache.req(URL_DATABASE, CD32_ROM, 0x80000, CD32_ROM_CRC, cfg.memory.rom);
        cache.req(URL_DATABASE, CD32_EXT_ROM, 0x80000, CD32_EXT_ROM_CRC, cfg.memory.extRom);		
        break;
    default:
...
//Affiche les sorties sur la console 'cxommenté par défaut)
	console.log(inf);
	console.log(cfg);
...
function preSelect(grp) {
	...
	function insertRow2(table, item) {
		...
		cell1.innerHTML = '<span class="is-size-6 has-text-info-50 is-uppercase">'+item[0]+'</span>';				
	...
	function insertRow4(table, item1, item2) {
		...
		if (item1 !== false) {
			cell1.innerHTML = '<span class="is-size-6 has-text-info-50 is-uppercase">'+item1[0]+'</span>';			
			cell2.innerHTML = '<span class="is-size-6 has-text-weight-bold">'+item1[1]+'</span>';	
		}
		cell1 = row.insertCell(-1);
		cell2 = row.insertCell(-1);
		cell2.style.width = "50%";
		if (item2 !== false) {
			cell1.innerHTML = '<span class="is-size-6 has-text-info-50 is-uppercase">'+item2[0]+'</span>';
...
//	var nameLink = dbe.name+" (<a target=\"_blank\" href=\""+href+"\">share</a>)";
	...
	table.classList.add('table', ('is-borderless'));
	table.id = "config_database_info_content";
	table.style.width = "100%";
	table.style.whiteSpace = "normal";

//	insertRow1(table, "<div style=\"height:25px\"></div>");
...
//	insertRow4(table, ["Name : ", nameLink], dbe.license.length ? ["License", license] : false);
	insertRow2(table, ["Name", nameLink]);
//	insertRow2(table, dbe.license.length ? ["License", license] : false);	
...
const COL_GRAY = "#888";
const COL_GREEN = "rgb(107, 246, 43)";
const COL_RED = "rgb(255, 0, 0)";
const COL_ORANGE = "rgb(255, 153, 0)";
